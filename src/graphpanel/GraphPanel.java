...
import datatypes.TimeSerieConfig;
import datatypes.TimeSerieRange;


public class GraphPanel extends JPanel implements GraphPanelInterface {
	...
	public boolean addTimeSerie(String name, TimeSerie timeSerie) {
		return this.addTimeSerie(name, timeSerie, GraphPanelConfig.COLOR_DEFALT_TIMESERIE);
	}

	@Override
	public boolean addTimeSerie(String name, TimeSerie timeSerie, Color color) {
		if (!this.isTimeSerieWithName(name)) {
